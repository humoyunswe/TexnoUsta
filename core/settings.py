...
SECRET_KEY = 'django-insecure-w1pm)79+m6mkgjy!222y4t0@9n&gc@pcwl76gu-0v47(f4ri%9'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'npg_YAm9quU1lSDR',  # пароль
        'HOST': 'ep-steep-hill-a914fv7i-pooler.gwc.azure.neon.tech',  # хост
        'PORT': '5432',  # порт
        'OPTIONS': {
